...
import {
    StyleSheet, Text, View, TextInput, ScrollView, Animated,
    TouchableOpacity, Platform, LayoutAnimation, Dimensions,
    UIManager,
} from 'react-native';
                        ...
                        <View style={styles.viewList}>
                            <View style={styles.textWrap}>
                                ...
                                <View style={styles.itemWrap}>
                                    ...
                                    <Text style={styles.ketFileText}>File yang diupload harus dalam bentuk/format (jpg, png, jpeg, pdf) maksimal 2MB</Text>
                                </View>
                                            ...
                                            <View key={res.key} style={styles.container2}>
                                                <View style = {{
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        {this.state.jawabanNama === res.key && <View style={styles.selectedRb} />}
                                                    </TouchableOpacity>
                                                </View>
                                                <View style={{
                                                    paddingHorizontal: 7,
                                            ...
                                            <View key={res.key} style={styles.container2}>
                                                <View style = {{
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        {this.state.jawabanAgama === res.key && <View style={styles.selectedRb} />}
                                                    </TouchableOpacity>
                                                </View>
                                                <View style={{
                                                    paddingHorizontal: 7,
                                            ...
                                            <View key={res.key} style={styles.container2}>
                                                <View style = {{
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        {this.state.jawabanNegara === res.key && <View style={styles.selectedRb} />}
                                                    </TouchableOpacity>
                                                </View>
                                                <View style={{
                                                    paddingHorizontal: 7,
                                ...
                                <View style={styles.itemWrap}>
                                    <Text style={styles.textItem}>
                                        Alias
                                        <Text style={styles.ketText}> (Kosongkan jika tidak memiliki alias)</Text>
                                        <Text style={{fontSize: 13, color:'#a12927'}}> *</Text>
                                    </Text>
                                    <View style = {{
                                        flexDirection: 'row',
