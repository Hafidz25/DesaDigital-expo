...
import {
    ...
    Platform, TouchableOpacity, ScrollView, SafeAreaView,
} from 'react-native';
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ marginTop: 10 }}>
                            <Text style={styles.headerText}>Bupati Malang Hadiri kegiatan Gema desa di kecamatan Tumpang...</Text>
                        </View>
                ...
                <ScrollView>
                    <View style={{
                        ...
                        <TouchableOpacity style={styles.batalBtn}
                        ...
                        <TouchableOpacity style={styles.batalBtn}
                            onPress={() => this.props.navigation.navigate('Tambah Data Warga')}>
                            <View style={{
                                flexDirection: 'row',
                                justifyContent: 'space-between'
                            }}>
                    ...
                    <View style={styles.menuContainer}>
                        <TouchableOpacity
                            ...
                            <View style={styles.menuBox}>
                                <Icon name="card-outline" size={25} color="#000" />
                            </View>
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.menuWrapper, { width: '25%' }]}>
                            <View style={styles.menuBox}>
                                <Icon style={{ left: 3 }} name="ellipsis-horizontal-outline" size={40} color="#000" />
                            </View>
